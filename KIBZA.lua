...
local Btn1 = createTabButton("Interactions", 0, 0.25)
local Btn2 = createTabButton("Local Player", 0.25, 0.25)
local Btn3 = createTabButton("In Game", 0.50, 0.25)
local Btn4 = createTabButton("Other", 0.75, 0.25)
...
----------------------------------------------------------------------
-- CORE ENGINE (Logic, Tracers & FOLLOW FIX)
----------------------------------------------------------------------
...
RunService.RenderStepped:Connect(function()
    ...
    if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
        ...
        -- FOLLOW TARGET LOGIC (Повернуто сюди!)
    ...
    if tracersEnabled and espEnabled then
        for _, player in pairs(Players:GetPlayers()) do
            if player ~= LocalPlayer and player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if not line then line = Drawing.new("Line"); line.Thickness = 1; line.Transparency = 0.7; activeTracers[player.Name] = line end
                if onScreen then
